export function headerTemplate() {
  return `
  <header class="pt-10 pb-4 px-5 text-center">
    <p class="text-xs font-bold tracking-widest uppercase text-primary mb-3">Retirement Planning</p>
  ...
  <section class="mx-4 sm:mx-auto sm:max-w-2xl mb-5">
    <button type="button"
      ...
      <span>
        ...
        <span class="text-muted text-xs ml-1.5">Tap to learn</span>
      </span>
      <svg class="w-4 h-4 text-muted transition-transform" :class="showHelp && 'rotate-180'"
        fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/>
      </svg>
    </button>
    <div x-show="showHelp" x-cloak
      class="mt-2 card text-sm text-muted leading-relaxed">
      <p class="mb-3">
        ...
        but always between a <strong class="text-ink">floor</strong> and a
        <strong class="text-ink">cap</strong> you choose.
      </p>
      <p class="mb-3">
        The calculator replays your plan through <strong class="text-ink">every starting month
        since 1871</strong> and reports how it held up. Whatever it shows is a ceiling &mdash;
